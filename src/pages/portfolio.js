...
export default () => (
    <Layout>
        ...
        <hr />
        <h3 style={{ marginBottom: '1rem' }}>Pete for America Campaign Website</h3>
          <div className="project-holder">
            <h4>Take Action</h4>

            <div className="project" style={{ marginTop: '2vh' }}>
              <div className="info">
                <div className="image-holder">
            ...
            <div className="project">
              <div className="info">
                <a href="http://whatsmypolitiq.com" target="_blank" rel="noopener noreferrer">
                  <div className="image-holder">
            ...
            <div className="project">
              <div className="info">
                <div className="image-holder">
                    ...
                    <img src={urbanArray2} className="hidden" alt="Urban Array onboarding page 1"/>
                    <img src={urbanArray4} className="hidden" alt="Urban Array dashboard"/>
                </div>
                <div className="description">
            ...
            <div className="project">
              <div className="info">
                <div className="image-holder">
                    <img src={recommendme3} className="mobile-hidden" alt="Recommend Me homepage"/>
                    <img src={recommendme2} className="hidden" alt="RecommendMe Search Page"/>
                </div>
                <div className="description">
            ...
            <div className="project">
              <div className="info">
                <div className="image-holder">
                    ...
                    <img src={abctraining2} className="hidden" alt="ABC Training admin view"/>
                    <img src={abctraining3} className="hidden" alt="ABC Training client select page"/>
                </div>
                <div className="description">
            ...
            <div className="project">
              <div className="info">
                <div className="image-holder">
                    ...
                    <img src={shoestring3} className="hidden" alt="Shoestring trip view page" style={{ marginBottom: '11vw' }}/>
                </div>
                <div className="description">
            ...
            <div className="project">
              <div className="info">
                <div className="image-holder">
                    <img src={battle1} className="hidden" alt="Battle landing page"/>
